...
- (void)addLines
{
    for (int i = 0; i<4; i++) {
        ...
        view.backgroundColor = [UIUtils colorNavigationBar];
...
- (void)setTitleViewForNavBar
{
    ...
    label.attributedText = [UIUtils attrString:@"Enable Passcode" withFont:[UIUtils fontForNavBarTitle] color:[UIColor whiteColor] andCharSpacing:[NSNumber numberWithInt:0]];
    [label sizeToFit];
