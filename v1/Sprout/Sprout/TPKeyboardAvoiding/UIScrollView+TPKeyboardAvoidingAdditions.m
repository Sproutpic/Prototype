...
- (void)TPKeyboardAvoiding_initializeView:(UIView*)view {
    ...
    // Crash Issue - Uncomment this later
    // -------------------------------------------------------------
    // I had to remove, as this was taking over the UITextFieldDelegate and the delegate I was setting was not getting called.
    // This might affect other issues in the app(s)
    
//    if (view && ([view isKindOfClass:[UITextField class]] || [view isKindOfClass:[UITextView class]])
//        && ([self conformsToProtocol:@protocol(UITextFieldDelegate)] || [self conformsToProtocol:@protocol(UITextViewDelegate)])
//        // This was causing crashes... The delegate had a bad access error
//        //&& ([(UITextField*)view delegate] && [(id<UITextFieldDelegate>)self isEqual:[(UITextField*)view delegate]])
//        ) {
//        
